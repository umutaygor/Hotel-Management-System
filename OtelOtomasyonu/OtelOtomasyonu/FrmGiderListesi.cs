...
namespace OtelOtomasyonu
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'otelOtomasyonuDataSet3.Giderler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.giderlerTableAdapter.Fill(this.otelOtomasyonuDataSet3.Giderler);
